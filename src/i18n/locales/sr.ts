...
export const sr: Messages = {
  ...
  "mix.zoomCam": "Зум камере",
  "mix.zoomCamHint":
    "Камера се приближава или удаљава од Сунца. Ради заједно са кружењем и подизањем, и током снимања.",
  "mix.zoomDir": "Смер зума",
  "mix.zoomIn": "Унутра",
  "mix.zoomInHint": "Приближи камеру Сунцу.",
  "mix.zoomOut": "Споља",
  "mix.zoomOutHint": "Удаљи камеру од Сунца.",
  "mix.zoomSpeed": "Брзина зума",
  "mix.zoomSpeedHint": "Колико брзо камера зумира. Независно од кружења и подизања.",
  "mix.zoomSpeedDisplay": "{speed} · {period}s од близу до далеко",
  ...
  "record.zoom": "Зум",
  "record.zoomOn": "Престани да зумираш. Кружење и висина могу да наставе.",
  "record.zoomOff": "Нека камера зумира. Ради заједно са кружењем и висином.",
  "record.exportHint":
