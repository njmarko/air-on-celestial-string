...
import { _ as Lock, a as Upload, b as EyeOff, c as Square, d as Play, f as Pause, g as Maximize2, h as Minus, i as Video, l as Search, m as Music, n as VolumeX, p as Orbit, r as Volume2, s as Trash2, t as X, u as Plus, v as ListMusic, y as Eye } from "../_libs/lucide-react.mjs";
import { t as create } from "../_libs/zustand.mjs";
import { a as hydrateLocale, c as useT, i as htmlLangFor, l as LANGUAGES, n as bodyName, o as useLocale, r as formatNote, s as useLocaleStore, u as __exportAll } from "./router-DaseX9aw.mjs";
import { t as clsx } from "../_libs/clsx.mjs";
import { t as twMerge } from "../_libs/tailwind-merge.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/routes-Y73NeSQY.js
...
function ia(item, file) {
	return `https://archive.org/download/${item}/${file.split("/").map(encodeURIComponent).join("/")}`;
}
var MUSOPEN = "MusopenCollectionAsFlac";
var CHOPIN = "musopen-chopin";
var SEASONS = "The_Four_Seasons_Vivaldi-10361";
var NAVY = "LightCavalryOvertureAndOtherWarhorses";
var WASPS = "OvertureToTheWasps";
var local = (file) => `/audio/${file}`;
var pack = (file) => `/audio/library/${file}`;
/**
...
function trackText(track, locale, field) {
...
if (typeof document !== "undefined") {
	import("./scene-manager-BqbPoM1M.mjs");
...
function VizCanvas() {
	...
	(0, import_react.useEffect)(() => {
		...
		Promise.all([import("./scene-manager-BqbPoM1M.mjs"), import("./texture-pack-BaRlWae6.mjs").then((n) => n.n).then((m) => m.loadTexturePack(mobile))]).then(([{ SceneManager }, pack]) => {
			if (cancelled || !host) {
				pack.dispose();
				return;
			}
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
					...
					className: `h-9 rounded-md px-2.5 text-xs font-medium ${autoElevate ? "bg-fg/10 text-primary" : "text-muted hover:bg-fg/10 hover:text-fg"}`,
					children: t("record.lift")
				}),
...
function CircleCameraSection() {
	...
	const liftPeriod = Math.round(30 / Math.max(.05, liftSpeed));
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		className: "space-y-1",
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Segmented, {
				...
				options: [{
					id: "up",
					label: t("mix.liftUp"),
					hint: t("mix.liftUpHint")
				}, {
					id: "down",
					label: t("mix.liftDown"),
					hint: t("mix.liftDownHint")
				}],
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)(RangeField, {
				...
				step: .05,
				value: liftSpeed,
				display: t("mix.liftSpeedDisplay", {
					speed: liftSpeed.toFixed(2),
					period: liftPeriod
				}),
...
function TrackList({ activeId, onPick, onAdd, compact = false }) {
	...
	const tracks = (0, import_react.useMemo)(() => LIBRARY.filter((track) => trackMatches(track, query)), [query]);
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", {
				...
				children: t("track.nTracks", { n: tracks.length })
			})]
		}), /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: cn("hud-scroll min-h-0 space-y-1 overflow-y-auto overscroll-contain pr-1", compact ? "max-h-[min(22rem,48dvh)]" : "max-h-[min(24rem,46dvh)]"),
			children: [tracks.length === 0 ? /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
				className: "px-3 py-6 text-center text-sm text-faint",
				children: t("track.noMatch")
			}) : tracks.map((track) => {
				...
				return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("button", {
					...
					className: cn("flex w-full items-center gap-3 rounded-lg px-3 text-left transition-colors duration-150", compact ? "h-12" : "min-h-12 py-1.5", active ? "bg-primary/15 text-fg" : "text-fg hover:bg-fg/10"),
...
function IntroCard({ onOpenFile, visible, ready }) {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "intro-card pointer-events-auto max-h-dvh w-full max-w-xl overflow-y-auto rounded-3xl p-6 md:p-8",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
					className: "mx-auto mt-4 max-w-md text-center text-sm leading-relaxed text-muted",
...
function trackLabel(t, locale, trackId, trackName) {
